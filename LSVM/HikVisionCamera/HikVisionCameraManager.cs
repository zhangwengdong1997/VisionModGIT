...
{
    class HikVisionCameraManager : ICameraManager
    {
        readonly List<ICamera> cameras = new List<ICamera>();
        ...
        public bool Init()
        {
            ...
            for (Int32 i = 0; i < stDevList.nDeviceNum; i++)
            {
                ...
                if (MyCamera.MV_GIGE_DEVICE == stDevInfo.nTLayerType)
                {
                    ...
                    camera.Mac = stDevInfo.nMacAddrLow.ToString();
                    cameras.Add(camera);
                }
            }
